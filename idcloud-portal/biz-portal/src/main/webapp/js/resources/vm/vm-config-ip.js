	...
	this.appendTr = function(ip) {
		if (ip != "" && ip != null) {
			var trHtml = "<tr>"
					...
					+ "<td>"
					+ "<input type='text' class='ipAddress jqx-widget-content jqx-widget-content-metro jqx-input jqx-input-metro jqx-widget jqx-widget-metro jqx-rc-all jqx-rc-all-metro' value='"
					+ ip
					+ "'/>"
			...
			var trHtml = "<tr>"
					+ "<td align='right'><font style='color:red'></font>IP地址：</td>"
					+ "<td>"
					+ "<input type='text' class='ipAddress jqx-widget-content jqx-widget-content-metro jqx-input jqx-input-metro jqx-widget jqx-widget-metro jqx-rc-all jqx-rc-all-metro'/>"
...
//	if (rowindex >= 0) {
		var data = $('#vmdatagrid').jqxGrid('getrowdata', row);
		resVmSid = data.resVmSid;
