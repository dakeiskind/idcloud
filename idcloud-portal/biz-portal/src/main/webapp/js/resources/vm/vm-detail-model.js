...
//    };
    ...
    this.initPopWindow = function(){
		...
		$("#vm-view-mgtObjMsg").jqxWindow({
			...
			autoOpen: false, 
			theme:currentTheme,
			cancelButton: $("#vm-cancelViewMgtObj"), 
			modalOpacity: 0.3,
			initContent: function () {
        	    $("#vm-cancelViewMgtObj").jqxButton({ width: '50',height:"25",theme:currentTheme});
	        }
		});
    };
...
function popVmDetailInfo(row){
    ...
    vmDetail.searchVmStorageInfo(data.resVmSid);
    vmDetail.searchVmNicInfo(data.resVmSid);
