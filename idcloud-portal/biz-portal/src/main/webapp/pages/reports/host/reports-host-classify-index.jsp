...
<body>
   ...
   <div style="width:900px;height:93%;margin-left:10px;">
		<iframe id="hostClassifyCountIframe" src="" width="100%" height="100%" frameborder="no" border="1" style="border:1px solid #E5E5E5" marginwidth="0" marginheight="0"></iframe>
	</div>
</body>
<script type="text/javascript">
	$(function(){
		...
		$("#hostClassifyCountIframe").attr("src",ws_url + "/rest/reports/host/jasper/hostClassifyCount/"+json).load(function() { 
			if($("#hostClassifyCountIframe").contents().find("#_blank").length > 0){
	...
	function downloadFile(obj,type){
		...
		if(!isok){
			...
			if("year" == timeType){
				...
				var json = JSON.stringify(objSearch);
				window.location = ws_url + "/rest/reports/host/export/jasper/hostClassifyCount/"+json; 
