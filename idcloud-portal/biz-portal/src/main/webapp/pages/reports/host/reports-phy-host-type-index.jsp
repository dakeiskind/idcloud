...
<body>
   ...
   <div style="width:850px;height:93%;margin-left:10px;">
		<iframe id="phyHostCountIframe" src="" width="100%" height="100%" frameborder="no" border="1" style="border:1px solid #E5E5E5" marginwidth="0" marginheight="0"></iframe>
	</div>
</body>
<script type="text/javascript">
	$(function(){
		...
		initInput();
		// 初始化inframe
		$("#phyHostCountIframe").attr("src",ws_url + "/rest/reports/host/jasper/phy/proportion").load(function() { 
			if($("#phyHostCountIframe").contents().find("#_blank").length > 0){
	...
	function downloadFile(obj,type){
		...
		if(!isok){
			window.location = ws_url + "/rest/reports/host/export/jasper/phy/proportion/"+type; 
		}
