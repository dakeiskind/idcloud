...
<body>
   ...
   <div style="width:900px;height:93%;margin-left:10px;">
		<iframe id="poolClassifyCountIframe" src="" width="100%" height="100%" frameborder="no" border="1" style="border:1px solid #E5E5E5" marginwidth="0" marginheight="0"></iframe>
	</div>
</body>
<script type="text/javascript">
	$(function(){
		...
		$("#poolClassifyCountIframe").attr("src",ws_url + "/rest/reports/host/jasper/poolClassifyCount/"+json).load(function() { 
			if($("#poolClassifyCountIframe").contents().find("#_blank").length > 0){
