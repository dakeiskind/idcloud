...
<script type="text/javascript">
    ...
    function initTicketMgtPageJs() {
        ...
        model.initPendingTicketMgtInput();
        model.initPendingTicketMgtDatagrid();
        model.initPendingTicketMgtPopWindow();
        model.initPendingValidator();

        model.searchObj.titleLike = '';
        model.searchObj.status = '02,03';
        $("#search-ticket-status").val("02");
