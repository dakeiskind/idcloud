           ...
           <table border="0" height="100%" cellspacing="0" cellpadding="2">
            	<tr>
            		<td align="right" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;服务地址：</td>
            			...
            			<td><input type="button" value="查询" onclick='searchExchangeConfigMgt()' id='search-exchange-button' /></td>
            	</tr>
            </table>
    </div>
	...
	<div id="addExchangeWindow">
	            ...
	            <div id="addExchangeForm" style="overflow: hidden;">
	                <table border="0" width="100%" cellspacing="5" cellpadding="0">
	                    ...
	                    <tr>
	                        <td align="right"><font style="color:red">*</font>最大邮箱存储容量:</td>
	                    ...
	                    <tr>
	                        ...
	                        <input style="margin-right: 5px;" onclick='addExchangeSubmit()' type="button" id="addExchangeSave" value="保存" />
       ...
       <div id="editExchangeWindow">
	            ...
	            <div id="editExchangeForm" style="overflow: hidden;">
	                ...
	                <table border="0" width="100%" cellspacing="5" cellpadding="0">
	                    ...
	                    <tr>
	                        <td align="right" colspan="4" height="40px">
	                        <input style="margin-right: 5px;" onclick='editExchangeSubmit()' type="button" id="editExchangeSave" value="保存" />
       ...
       <div id="exchangeDetailInfoWindow">
	            <div>Exchange详细信息</div>
	            <div id="exchangeDetailInfoForm" style="overflow: hidden;">
	            	<div style="width:99%;height:320px;">
	            		<div id='exchangeDetailInfoDatagrid' style="width:100%;height:100%;"></div> 
	            	</div>
	            	<div style="width:99%;height:40px;text-align:right;line-height:50px;">
	            		<input id="exchangeDetailInfoCancel" type="button" value="取消" />&nbsp;&nbsp;
	            	</div>
	            </div>
       </div>    
