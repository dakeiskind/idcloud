  	...
  	<div style="position:relative;width:98%;height:140px;margin-left:1%;">
  		<div class="customPanel" style="position:absolute;top:0px;left:0px;width:47%;height:435px;">
  		    <div class="title">&nbsp;&nbsp;基本信息
  		    	<font style="position:absolute;right:5px;cursor:pointer" onclick="popEditRespoolSharepointWindow()"><i class="icons-blue icon-edit"></i></font>
  		    </div>   
	        <div>
	        	<table id="clusterBaseInfo" border="0" width="100%" cellspacing="2" cellpadding="0">
	        		<tr>
	        			...
	        			<td align="left">
	        				<span id="resPoolName-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">类型：</td>
	        			<td align="left">
	        				<span id="pooltype-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">分配策略：</td>
	        			<td align="left">
	        				<span id="allocationPolicy-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">换算公式：</td>
	        			<td align="left">
	        				<span id="conversionFormula-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">可分配阀值：</td>
	        			<td align="left">
	        				<span id="allocationThreshold-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">性能保障等级：</td>
	        			<td align="left">
	        				<span id="perfLevel-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">资源池状态：</td>
	        			<td align="left">
	        				<span id="statusName-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">操作处理器：</td>
	        			<td align="left">
	        				<span id="operationHandler-sharepoint"></span>
	        			</td>
	        		</tr>
	        		<tr>
	        			<td align="right" height="25px">资源池描述：</td>
	        			<td align="left">
	        				<span id="description-sharepoint"></span>
	        			</td>
	        		</tr>
	        	</table>
	        </div>
	        ...
	        <div>
	        	<table border="0" width="97%" style="margin-left:3%" cellspacing="5" cellpadding="0">
	        		<tr>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="removeSharepointRespool()"><i class="icon-cancel-3"></i>&nbsp;删除资源池</span></td>
<!-- 	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="popAddVlanToPoolWindow()"><i class="icon-desktop"></i>&nbsp;添加VLAN入池</span></td> -->
  ...
  <%@ include file="../../pool/res-edit-pool-sharepoint.jsp"%>
...
<script type="text/javascript">
     ...
     function initRespoolSummary(){
 		// 初始化统计信息值
   		...
   		var spdata =  sp.spResourcesStatistics();
   		 
    	 // 初始化资源统计值
    	 var respool = new editResPoolModel();
    	 // 初始化sharepoint基本信息值
    	 respool.setSharepointResPool();
    	 // 初始化sharepoint的window
    	 respool.initSharePointPopWindow();
    	 // 初始化sharepoint验证
    	 respool.initSharePointValidator();

    	 initSharepointChart(spdata);
     } 
	
	// 初始化vlan图表
	 function initSharepointChart(data){
		 var source =
         {
             datatype: "json",
             datafields: [
         ...
         var settings = {
             title: "Sharepoint资源统计",
             description: "(总数:"+data.spCount+"个)",
