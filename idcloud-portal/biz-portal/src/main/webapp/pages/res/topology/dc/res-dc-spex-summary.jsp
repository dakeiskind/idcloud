  		...
  		<div class="customPanel" style="width:49.5%;height:125px;float:left">
	        ...
	        <div>
	        	<table border="0" width="97%" style="margin-left:3%" cellspacing="5" cellpadding="0">
	        		<tr>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="popAddRespoolSharepointWindow()"><i class="icon-plus-circled"></i>&nbsp;添加SharePoint资源池</span></td>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="popAddRespoolExchangeWindow()"><i class="icon-plus-circled"></i>&nbsp;添加Exchange资源池</span></td>
...
<script type="text/javascript">
	...
	function initSpExDCSummary(){
		
		// 初始化统计信息值
   	 	var sharepoint = new SharepointConfigModel();
   		var spdata =  sharepoint.spResourcesStatistics();
   		
		// 初始化统计信息值
   	 	var exchange = new ExchangeConfigModel();
    	var exdata =  exchange.exResourcesStatistics();
