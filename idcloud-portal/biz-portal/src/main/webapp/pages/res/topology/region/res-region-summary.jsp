  	...
  	<div style="width:98%;height:140px;margin-left:1%;">
  		<div class="customPanel" style="width:49.5%;height:125px;float:left">
  		    <div class="title">&nbsp;&nbsp;基本信息
  		    	<font style="cursor:pointer;position:absolute;right:5px" onclick="popEditHostRegionWindow()"><i class="icons-blue icon-edit"></i></font>
  		    </div>   
	        <div>
...
<!-- 	  		         <font style="position:absolute;right:5px"><i class="icons-blue icon-help"></i></font> -->
	        ...
	        <div>
	        	<table border="0" width="97%" style="margin-left:3%" cellspacing="5" cellpadding="0">
	        		<tr>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="popAddHostRegionWindow()"><i class="icon-list-add" ></i>&nbsp;添加区域</span></td>
	        			...
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="removeDcAndCluster('01')"><i class="icons-blue icon-cancel-3"></i>&nbsp;删除区域</span></td>
	        		</tr>
	        	</table>
	        </div>
  		</div>
