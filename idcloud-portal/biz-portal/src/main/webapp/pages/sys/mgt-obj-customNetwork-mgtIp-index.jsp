...
<div id="viewCustomNetworkOwnIpGrid">
	 <div>管理IP列表</div>
          		...
          		<div style="width:100%;height:30px;padding:10px 0px 10px 0px;">
			           <table border="0" height="100%" cellspacing="0" cellpadding="2">
			            	<tr>
			            			...
			            			<td><input type="text" id="search-custom-network-IP-address" />&nbsp;&nbsp;</td>
			            			<td align="right">&nbsp;&nbsp;使用状态：</td>
			            			<td>
			            				<div id="search-custom-network-IP-usage-status"></div>
			            			</td>
			            			<td><input type="button" value="查询" onclick='searchNetworkIpConfigMgt()' id='search-custom-network-ip-button' /></td>
			            	</tr>
			            </table>
                  </div>
			     <div style="width:98%;margin-left:1%;overflow-y:auto;height:345px;"> 
			     	<div id='customnNetworkIpConfigMgtdatagrid' style="width:99.9%;"></div> 
			     </div>
			     <div style="width:100%;margin-top:5px;text-align:right">
		              <input id="customNetworkIpCancel" type="button" value="取消" />&nbsp;&nbsp;
