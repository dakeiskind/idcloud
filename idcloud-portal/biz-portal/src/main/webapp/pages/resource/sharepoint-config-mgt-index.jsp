   ...
   <div style="width:100%;height:30px;padding:10px 0px 10px 0px;">
           <table border="0" height="100%" cellspacing="0" cellpadding="2">
            	<tr>
            		<td align="right" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;服务地址：</td>
            			...
            			<td><input type="button" value="查询" data-bind='click:searchSharepointConfigMgt' id='search-sharepoint-button' /></td>
            	</tr>
            </table>
    </div>
	...
	<div id="addSharepointWindow">
	            ...
	            <div id="addSharepointForm" style="overflow: hidden;">
	                <table border="0" width="100%" cellspacing="5" cellpadding="0">
	                    ...
	                    <tr>
	                        ...
	                        <input style="margin-right: 5px;" data-bind='click:addSharepointSubmit' type="button" id="addSharepointSave" value="保存" />
       ...
       <div id="editSharepointWindow">
	            ...
	            <div id="editSharepointForm" style="overflow: hidden;">
	                ...
	                <table border="0" width="100%" cellspacing="5" cellpadding="0">
	                    ...
	                    <tr>
	                        <td align="right" colspan="4" height="40px">
	                        <input style="margin-right: 5px;" data-bind='click:editSharepointSubmit' type="button" id="editSharepointSave" value="保存" />
      ...
      <script type="text/javascript">
      		function initSharepointConfigJs(){
       		 // 初始化sys-index页面model
