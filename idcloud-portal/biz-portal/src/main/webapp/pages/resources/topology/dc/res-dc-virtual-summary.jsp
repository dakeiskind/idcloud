	        	...
	        	<table id="datacenterBaseInfo" border="0" width="100%" cellspacing="0" cellpadding="5">
	        		...
	        		<tr>
	        			...
	        			<td align="left">
	        				...
	        				<!-- <div id="description" style="width:35%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;"></div> -->
<!-- 	        				<div id="description" style="height:30px;line-height:30px;overflow-y: auto;overflow-x:hidden;"></div> -->
	        			</td>
	        		</tr>
	        	</table>
	        </div>
...
<!-- 	  		         <font style="position:absolute;right:5px"><i class="icons-blue icon-help"></i></font> -->
	        ...
	        <div>
	        	<table border="0" width="97%" style="margin-left:3%" cellspacing="5" cellpadding="0">
	        		<tr>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="popAddVeWindow()"><i class="icon-list-add" ></i>&nbsp;添加资源环境</span></td>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="removeZoneOrDc('DC')"><i class="icons-blue icon-cancel-3"></i>&nbsp;删除数据中心</span></td>
	        		</tr>
	        	</table>
	        </div>
  		</div>
  	...
  	<div style="width:98%;height:370px;margin-left:1%;">
        ...
        <div>
        	<div id='hostChart' style="width:33%;height:320px;float:left;border: 0;"></div>
        	<div id='storageChart' style="width:33%; height:320px;float:left;border: 0;"></div>
        	<div id='VmChart' style="width:33%; height:320px;float:left;border: 0;"></div>	
        </div>
  		</div>
  	</div>
  </div>
