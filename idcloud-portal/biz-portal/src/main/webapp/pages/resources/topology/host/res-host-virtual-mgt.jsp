...
<div id='hostTabs' style="border:0px;">
    ...
    <div id='host_summary'>  
        <%@ include file="res-host-virtual-summary.jsp"%>
    </div>
...
<script type="text/javascript">
	 ...
	 $('#hostTabs').on('selected', function (event) {
	  	   var pageIndex = event.args.item;  
	  	    if(pageIndex == 1){
          	// 虚拟机
          	$("#hostTabsContent1").load(ctx+"/pages/resources/vm/res-vm-datagrid-index.jsp",function(){
      		    VMDatagridModel();
      	    });
          }else if(pageIndex == 2){
          	// 存储
          	$("#hostTabsContent2").load(ctx+"/pages/resources/storage/res-storage-host-index.jsp",function(){	
          		//initVMTabs();
			});
          }
