...
<!-- 	  		         <font style="position:absolute;right:5px"><i class="icons-blue icon-help"></i></font> -->
	        ...
	        <div>
	        	<table border="0" width="97%" style="margin-left:3%" cellspacing="5" cellpadding="0">
	        		<tr>
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="addPneNetworkInfoWindow()"><i class="icon-list-add" ></i>&nbsp;新增外部网络</span></td>
	        		</tr>
	        	</table>
	        </div>
  		</div>
  	...
  	<div style="width:98%;height:370px;margin-left:1%;">
        ...
        <div>
        	<div id='VmChart' style="width:50%; margin:0 auto; height:320px;border: 0;"></div>	
        </div>
  		</div>
  	</div>
  </div>
