...
<style type="text/css">
  ...
  <div id="resDChostSummary" style="width:100%;height:100%;">
  	...
  	<div style="width:98%;height:140px;margin-left:1%;">
  		<div class="customPanel" style="width:40.5%;height:240px;float:left;z-index:999">
	        ...
	        <div>
	        	<table id="datacenterBaseInfo" border="0" width="100%" cellspacing="0" cellpadding="5">
	        		<tr>
	        			...
	        			<td align="left">
	        				<span id="resTopologyName">物理资源池</span>
	        			</td>
	        		</tr>
	        		<tr>
...
<!-- 	        		</tr> -->
	        		<tr>	
	        			<td align="left" height="25px"><span style="cursor:pointer;color:#3B9AFF" onclick="removeZoneOrDc('03')"><i class="icons-blue icon-cancel-3"></i>&nbsp;删除计算资源池</span></td>
	        		</tr>
	        	</table>
	        </div>
  		</div>
