...
<%--   <%@ include file="res-vm-migrate-target-host.jsp"%> --%>
	...
	<div id="vm-view-mgtObjMsg">
     	<div>项目详情信息</div>
     	<div style="overflow: hidden;">
	   		<table border="0" width="100%" cellspacing="0" cellpadding="5" class="tableCss">
	             <tbody id="vm-view-mgtObjDetail"></tbody>
	         </table>
	         <div style="text-align: right;margin-top: 10px;"><input id="vm-cancelViewMgtObj" style="margin-right: 5px;width:60px;height:23px"  type="button" value="取消" /></div>
        </div>
	</div>
