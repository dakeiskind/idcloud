 ...
 */
package com.h3c.idcloud.infrastructure.common.util.ssh;
...
import static com.h3c.idcloud.infrastructure.common.util.ssh.ASN1Codec.decodeRSAPrivateKey;
import static com.h3c.idcloud.infrastructure.common.util.ssh.ASN1Codec.decodeRSAPublicKey;
import static com.h3c.idcloud.infrastructure.common.util.ssh.ASN1Codec.encode;
...
public class Pems {
     ...
     * @param processor how to parser the object from a byte array
    ...
    public static KeySpec privateKeySpec(ByteSource supplier) throws IOException {
        return fromPem(supplier,
                       new PemProcessor<KeySpec>(ImmutableMap.<String, PemProcessor.ResultParser<KeySpec>>of(
                               ...
                               DecodeRSAPrivateCrtKeySpec.INSTANCE,
     ...
     * format.
     *
     * @param pem private key in pem encoded format.
     * @return the key spec
     *
     * @see Pems#privateKeySpec(ByteSource) Pems#privateKeySpec(ByteSource)
     */
    ...
    public static KeySpec publicKeySpec(ByteSource supplier) throws IOException {
        return fromPem(supplier,
                       new PemProcessor<KeySpec>(ImmutableMap.<String, PemProcessor.ResultParser<KeySpec>>of(
                               PUBLIC_PKCS1_MARKER,
                               DecodeRSAPublicKeySpec.INSTANCE,
                               PUBLIC_X509_MARKER,
                               new PemProcessor.ResultParser<KeySpec>() {
     ...
     * format.
     *
     * @param pem public key in pem encoded format.
     * @return the key spec
     *
     * @throws IOException the io exception
     * @see Pems#publicKeySpec(ByteSource) Pems#publicKeySpec(ByteSource)
     */
     ...
     *
     * @param supplier    the input stream factory
     * @param certFactory or null to use default
     * @return the {@link X509EncodedKeySpec} which was PEM encoded in the stream
     *
     * @throws IOException          if an I/O error occurs
     * @throws CertificateException the certificate exception
     */
    public static X509Certificate x509Certificate(ByteSource supplier, CertificateFactory certFactory) throws IOException, CertificateException {
                           ...
                           new PemProcessor<X509Certificate>(ImmutableMap.<String, PemProcessor.ResultParser<X509Certificate>>of(
                                   ...
                                   new PemProcessor.ResultParser<X509Certificate>() {
                                       ...
                                       public X509Certificate parseResult(byte[] bytes) throws IOException {
                                           try {
                                               return (X509Certificate) certs.generateCertificate(new ByteArrayInputStream(
                                                       bytes));
     ...
     *
     * @param pem certificate in pem encoded format.
     * @return the x 509 certificate
     *
     * @throws IOException          the io exception
     * @throws CertificateException the certificate exception
     * @see Pems#x509Certificate(ByteSource, CertificateFactory) Pems#x509Certificate(ByteSource, CertificateFactory)
     */
    ...
    private static class PemProcessor<T> implements ByteProcessor<T> {
        ...
        public T getResult() {
            ...
            checkState(parsers.containsKey(beginMarker),
                       "Invalid PEM: no parsers for marker %s in %s",
                       beginMarker,
                       parsers.keySet()
            );
            try {
