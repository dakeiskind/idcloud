...
public class ClassLoaderUtil {
		...
		try {
			...
			while (dirs.hasMoreElements()) {
				...
				if ("file".equals(protocol)) {
					...
					findClassesInPackage(packageName, filePath,
							recursive, classes);
			...
			e.printStackTrace();
			throw new RpcException(RpcException.UNKNOWN_EXCEPTION,e.getMessage());
		}
     ...
     * @param classes
     */
	public static void findClassesInPackage(String packageName,
		...
		for (File file : dirFiles) {
			if (file.isDirectory()) {
				findClassesInPackage(packageName + "."
