...
/**
 * 测试用内嵌ServerContainer. 用法:
 * <ul>
 * <li>InMemoryRestServer server = InMemoryRestServer.create(...) 传入Rest的实例</li>
 * <li>server.baseUri() 是 BaseUrl</li>
 * <li>server.newRequest("/relative/resource/path") 来创建Rest请求测试，路径起始是该Rest类的Path开始</li>
 * <li>server.close() 停止服务</li>
 * </ul>
 *
 * @author Chaohong.Mao
 */
