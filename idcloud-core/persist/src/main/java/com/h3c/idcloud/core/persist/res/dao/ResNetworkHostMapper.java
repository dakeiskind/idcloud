...
public interface ResNetworkHostMapper {
     ...
     *
     * @param resNetworkSid the res network sid
     * @return the res network host
     */
    ResNetworkHost selectByPrimaryKey(String resNetworkSid);
     ...
     * @return the int
     */
    int updateByParamsSelective(@Param("record") ResNetworkHost record, @Param("condition") Map<String, Object> condition);
     ...
     * @return the int
     */
    int updateByParams(@Param("record") ResNetworkHost record, @Param("condition") Map<String, Object> condition);
