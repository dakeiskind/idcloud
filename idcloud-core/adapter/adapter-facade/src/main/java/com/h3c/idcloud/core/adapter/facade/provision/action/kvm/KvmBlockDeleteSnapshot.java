...
@Service
public class KvmBlockDeleteSnapshot extends ActionKvm {

    @Override
    protected CommonAdapterResult execute(Base base) throws KvmException,
            AdapterUnavailableException {
        // TODO Auto-generated method stub
        BlockSnapshotDelete blcokSnapShotDelete = (BlockSnapshotDelete) base;

        //String json = helper.getParam(blcokSnapShotDelete.getProviderType(), blcokSnapShotDelete);

        log.info("block shanpshot delete");
        ...
        try {
            Response resp = client.path("/" + blcokSnapShotDelete.getTenantId() + "/volumes/" + blcokSnapShotDelete.getVolumeId() + "/volume_snapshots/" + blcokSnapShotDelete.getSnapshotId()).type(MediaType.APPLICATION_JSON).delete();
