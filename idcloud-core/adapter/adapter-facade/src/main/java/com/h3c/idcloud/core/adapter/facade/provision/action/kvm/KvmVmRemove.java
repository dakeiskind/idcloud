...
@Service
public class KvmVmRemove extends ActionKvm {

    private static Logger log = LoggerFactory.getLogger(KvmVmRemove.class);
    ...
    protected CommonAdapterResult execute(Base base) throws KvmException, AdapterUnavailableException {
        ...
        try {
            Response resp = client.path("/" + vmRemove.getTenantId() + "/servers/" + vmRemove.getId()).type(MediaType.APPLICATION_JSON).delete();
