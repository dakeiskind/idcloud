...
@Service
public class VmwareDataStoreDelete extends ActionVmware {

    private static Logger log = LoggerFactory.getLogger(VmwareDataStoreDelete.class);
    ...
    protected CommonAdapterResult execute(Base base) throws VmwareException,
        ...
        try {
            Response resp = client.path("/datastore/delete")
            ...
            log.info("vmware adapter is not available when deleting datastore");
