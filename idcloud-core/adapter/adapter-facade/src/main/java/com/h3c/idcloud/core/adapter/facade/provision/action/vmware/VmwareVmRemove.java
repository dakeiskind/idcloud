...
@Service
public class VmwareVmRemove extends ActionVmware {

    private static Logger log = LoggerFactory.getLogger(VmwareVmRemove.class);
    ...
    protected CommonAdapterResult execute(Base base) throws VmwareException,
        ...
        try {
            ...
            log.info("vmware adapter is not available when removing vm");
