...
@Service
public class VmwareDataStoreRefresh extends ActionVmware {

    private static Logger log = LoggerFactory.getLogger(VmwareDataStoreRefresh.class);
    ...
    protected CommonAdapterResult execute(Base base) throws VmwareException,
        ...
        log.info("datastore refresh post data : " + json);
        ...
        try {
            Response resp = client.path("/datastore/refresh")
            ...
            log.info("vmware adapter is not available when refresh datastore");
