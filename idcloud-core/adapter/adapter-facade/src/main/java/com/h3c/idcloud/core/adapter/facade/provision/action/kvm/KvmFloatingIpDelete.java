...
@Service
public class KvmFloatingIpDelete extends ActionKvm {

    @Override
    protected CommonAdapterResult execute(Base base) throws KvmException,
            AdapterUnavailableException {
        FloatingIpDelete floatingIpDelete = (FloatingIpDelete) base;

        CommonAdapterResult result = new CommonAdapterResult();

        log.info("delete folatingIp ");
        ...
        try {
            Response resp = client.path("/" + floatingIpDelete.getTenantId() + "/floating_ips/" + floatingIpDelete.getFloatingIpId()).type(MediaType.APPLICATION_JSON).delete();
