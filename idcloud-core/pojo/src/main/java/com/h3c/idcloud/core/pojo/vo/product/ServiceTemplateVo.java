...
public class ServiceTemplateVo implements Serializable {
     ...
     * 模板规格集合
     */
    private List<ServiceTemplateSpecVo> specifications;
    
    /**
     * 服务规格集合
     */
    private List<ServiceSpecVo> serviceSpecVos;
	 ...
	 */
	public List<ServiceTemplateSpecVo> getSpecifications() {
	 ...
	 */
	public void setSpecifications(List<ServiceTemplateSpecVo> specifications) {
	...
	public List<ServiceSpecVo> getServiceSpecVos() {
		return serviceSpecVos;
	}

	public void setServiceSpecVos(List<ServiceSpecVo> serviceSpecVos) {
		this.serviceSpecVos = serviceSpecVos;
	}
