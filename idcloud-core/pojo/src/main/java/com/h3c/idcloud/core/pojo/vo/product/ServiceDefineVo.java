...
public class ServiceDefineVo implements Serializable {
     ...
     * 服务配置list
     */
    private List<ServiceConfigVo> serviceConfigVo;

    /**
     * 服务规格list
     */
    private List<ServiceSpecVo> serviceSpecVo;
     ...
     * 服务性能指标list
     */
    private List<ServicePerfVo> servicePerfVo;

    /**
     * 服务操作项list
     */
    private List<ServiceOperationVo> serviceOperationVo;
	...
	public List<ServiceConfigVo> getServiceConfigVo() {
		return serviceConfigVo;
	}

	public void setServiceConfigVo(List<ServiceConfigVo> serviceConfigVo) {
		this.serviceConfigVo = serviceConfigVo;
	}

	public List<ServiceSpecVo> getServiceSpecVo() {
		return serviceSpecVo;
	}

	public void setServiceSpecVo(List<ServiceSpecVo> serviceSpecVo) {
		this.serviceSpecVo = serviceSpecVo;
	}

	public List<ServicePerfVo> getServicePerfVo() {
		return servicePerfVo;
	}

	public void setServicePerfVo(List<ServicePerfVo> servicePerfVo) {
		this.servicePerfVo = servicePerfVo;
	}

	public List<ServiceOperationVo> getServiceOperationVo() {
		return serviceOperationVo;
	}

	public void setServiceOperationVo(List<ServiceOperationVo> serviceOperationVo) {
		this.serviceOperationVo = serviceOperationVo;
	}
