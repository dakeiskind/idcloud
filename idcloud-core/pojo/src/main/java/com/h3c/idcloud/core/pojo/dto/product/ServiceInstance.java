...
public class ServiceInstance implements Serializable {
	...
	public String getSidAndName() {
		return sidAndName;
	}

	public void setSidAndName(String sidAndName) {
		this.sidAndName = sidAndName;
	}
	...
	public String getMgtObjSids() {
		return mgtObjSids;
	}

	public void setMgtObjSids(String mgtObjSids) {
		this.mgtObjSids = mgtObjSids;
	}
