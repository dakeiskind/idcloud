...
public class ResEquipBladeFrame extends ResEquipInfo implements Serializable {
    ...
    private Long staTotalFrame;
    private String equipRackName;
    private String equipRoomName;


    /**
     * @return the staTotalFrame
     */
    public Long getStaTotalFrame() {
        return staTotalFrame;
    }

    /**
     * @param staTotalFrame the staTotalFrame to set
     */
    public void setStaTotalFrame(Long staTotalFrame) {
        this.staTotalFrame = staTotalFrame;
    }
