...
public class ServiceCatalog implements Serializable {
     ...
     * 服务集合
     */
    private List<ServiceDefine> serviceDefineList;
    /**
     * @return 目录SID
     */
	 ...
	 */
	public List<ServiceDefine> getServiceDefineList() {
		return serviceDefineList;
	}

	/**
	 * @param serviceDefineList the serviceDefineList to set
	 */
	public void setServiceDefineList(List<ServiceDefine> serviceDefineList) {
		this.serviceDefineList = serviceDefineList;
	}
